...
describe('configuration', () => {
  ...
  it.each([
    ...
    [{ ...valid, SOURCE_UI_ORIGIN: 'http://[::1]:3000' }, /canonical HTTPS or 127\.0\.0\.1 HTTP origin/],
    [{ ...valid, SOURCE_UI_ORIGIN: 'http://user:pass@127.0.0.1:3000' }, /canonical HTTPS or 127\.0\.0\.1 HTTP origin/],
    [{ ...valid, SOURCE_UI_ORIGIN: 'http://127.0.0.1:3000/' }, /canonical HTTPS or 127\.0\.0\.1 HTTP origin/],
